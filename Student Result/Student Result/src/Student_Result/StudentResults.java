...
import javax.swing.JButton;
		...
		public class StudentResults {
			...
			private void initialize() {
				...
				panel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 4), "Student Result Systems", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
				...
				panel_1.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 4), "Student Transcript", TitledBorder.CENTER, TitledBorder.TOP, null, null));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Student_ID", "Sure Name", "Course_Code", "Math", "English", "Computing", "Chemistry", "Biology", "Economices", "Average", "Ranking", "Total Score"
			}
		));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				model.addRow(new Object[]{
						...
						textField_StudentID.getText().toString(),
						...
						textField_7.getText().toString(),
						textField_8.getText().toString(),
						textField_9.getText().toString(),
						textField_10.getText().toString(),
						textField_12.getText().toString()
						});
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRow()==1) {
					if(table.getRowCount()==0) {
						...
						JOptionPane.showMessageDialog(null, "No data ti delete",
