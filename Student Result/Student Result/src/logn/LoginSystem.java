...
public class LoginSystem {
	...
	private void initialize() {
		...
		btnNewButton_1.setFont(new Font("Symbol", Font.PLAIN, 14));
		...
		btnNewButton_1.setIcon(new ImageIcon("C:\\Users\\LENOVO\\Desktop\\Daffodil-International-University-DIU-logo.png"));
		btnNewButton_1.setSelectedIcon(null);
		btnNewButton_1.setBackground(Color.WHITE);
		btnNewButton_1.setBounds(0, 0, 642, 138);
		frame.getContentPane().add(btnNewButton_1);
		
		
		
		JButton button = new JButton("");
		button.setIcon(new ImageIcon("C:\\Users\\LENOVO\\Desktop\\download.png"));
		button.setBackground(Color.CYAN);
		button.setBounds(0, 151, 304, 222);
